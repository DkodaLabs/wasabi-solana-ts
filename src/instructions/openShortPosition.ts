...
const openShortPositionSetupConfig: BaseMethodConfig<
    ...
    OpenShortPositionSetupInstructionAccounts
    | OpenShortPositionSetupInstructionAccountsStrict
> = {
    process: async (config: ConfigArgs<
        OpenShortPositionSetupArgs,
        OpenShortPositionSetupAccounts
    >) => {
        const [collateralTokenProgram, currencyTokenProgram] = await config
            .program
            .provider
            .connection
    ...
    getMethod: (program) => (args) => program.methods.openShortPositionSetup(
        args.nonce,
...
const openShortPositionCleanupConfig: BaseMethodConfig<
    ...
    OpenShortPositionCleanupInstructionAccounts
    | OpenShortPositionCleanupInstructionAccountsStrict
> = {
